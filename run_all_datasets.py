...
def create_output_structure(base_output_dir, job_id):
    ...
    with open(readme_path, 'w') as f:
        ...
        f.write(f"\nImages saved to: /home/gkianfar/scratch/Amin/Sedo/output/imageout/\n")
...
def run_single_dataset(dataset_path, subdirs, script_path, timeout):
    ...
    if 'cifar' in dataset_name.lower():
        ...
        effective_timeout = max(timeout, 28800)  # at least 8 hours
            ...
            if os.path.exists(progress_log_path):
                with open(progress_log_path, 'r') as f:
                    already_processed = any(
                        json.loads(line).get('dataset') == dataset_name
